...
const sourceFiles = [
  ...
  'https://raw.githubusercontent.com/crazy-max/WindowsSpyBlocker/master/data/hosts/spy.txt'], target: path.join('f', 'ads.txt') },
  ...
  'https://blocklist.sefinek.net/generated/0.0.0.0/forks/MajkiIT.adguard_host.txt'], target: path.join('f', 'ads-2.txt') },
  ...
  'https://raw.githubusercontent.com/MajkiIT/polish-ads-filter/master/polish-pihole-filters/hostfile.txt'], target: path.join('f', 'ads-3.txt') },
  ...
  'https://blocklist.sefinek.net/generated/0.0.0.0/forks/MajkiIT.hostfile.txt'], target: path.join('f', 'gen.txt') },
  ...
  'https://blocklist.sefinek.net/generated/0.0.0.0/forks/FadeMind.add.Spam.txt'], target: path.join('f', 'gen-2.txt') },
  ...
  'https://s3.amazonaws.com/lists.disconnect.me/simple_malvertising.txt'], target: path.join('f', 'gen-3.txt') },
  ...
  'https://blocklist.sefinek.net/generated/0.0.0.0/forks/blocklistproject.redirect.txt'], target: path.join('f', 'gen-4.txt') },
  ...
  'https://blocklist.sefinek.net/generated/0.0.0.0/forks/r-a-y.AdguardMobileSpyware.txt'], target: path.join('f', 'gen-5.txt') },
  ...
  'https://blocklist.sefinek.net/generated/0.0.0.0/forks/developerdan.hate-and-junk-extended.txt'], target: path.join('f', 'illegal.txt') },
  { urls: ['https://blocklistproject.github.io/Lists/crypto.txt',
  'https://blocklist.sefinek.net/generated/0.0.0.0/forks/blocklistproject.redirect.txt'], target: path.join('f', 'other-junk.txt') },
  { urls: ['https://raw.githubusercontent.com/oli11gh/pi-hole-block-list/main/myblocklist.txt',
  'https://zerodot1.gitlab.io/CoinBlockerLists/hosts_browser'], target: path.join('f', 'other.txt') },
...
setInterval(updateFilesAndCommit, 2 * 60 * 60 * 1000);
